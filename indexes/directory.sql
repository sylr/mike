...
CREATE INDEX directory_name_btree_idx               ON mike.directory   USING btree (id_user, name)     WITH (fillfactor = 95);
CREATE INDEX directory_ctime_btree_idx              ON mike.directory   USING btree (id_user, ctime)    WITH (fillfactor = 95);
